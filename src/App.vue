...
import FeatureComponents from './components/FeatureComponents.vue'
...
<template>
  ...
  <main v-if="showCart">
    <cart-component :cart="cart" @increment-book="incrementBookToCart" @decrement-book="decrementBookToCart"
